...
- Race conditions
- Async await denial
- Stack traces longer than my future
- Making technical debt look intentional
- Currently Learning
- Industrial-grade Overthinking
- Performance optimisation before the app exists
- Regex I found on StackOverflow
- Garbage collection appreciation
- Rats (distributed systems mascots)
